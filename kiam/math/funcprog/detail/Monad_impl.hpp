...
DEFINE_FUNCTION_3(5, constexpr LIFTM2_TYPE(T0, T1, T2, T3, T4), liftM2, function_t<T2(T3, T4)> const&, f, T0 const&, m0, T1 const&, m1,
    return _do2(x0, m0, x1, m1, return Monad_t<T0>::mreturn(f(x0, x1)););)

// liftM3 :: Monad m => (a1 -> a2 -> a3 -> r) -> m a1 -> m a2 -> m a3 -> m r 
DEFINE_FUNCTION_4(7, constexpr LIFTM3_TYPE(T0, T1, T2, T3, T4, T5, T6), liftM3, function_t<T3(T4, T5, T6)> const&, f,
    T0 const&, m0, T1 const&, m1, T2 const&, m2,
        return _do3(x0, m0, x1, m1, x2, m2, return Monad_t<T0>::mreturn(f(x0, x1, x2)););)

// liftM4 :: Monad m => (a1 -> a2 -> a3 -> a4 -> r) -> m a1 -> m a2 -> m a3 -> m a4 -> m r 
DEFINE_FUNCTION_5(9, constexpr LIFTM4_TYPE(T0, T1, T2, T3, T4, T5, T6, T7, T8), liftM4,
...
DEFINE_FUNCTION_6(11, constexpr LIFTM5_TYPE(T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), liftM5,
...
DEFINE_FUNCTION_2(2, constexpr AP_TYPE(T0, T1), ap, T1 const&, mf, T0 const&, mv,
