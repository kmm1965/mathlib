...
using liftA2_type = std::enable_if_t<
    ...
    typeof_t<AY, remove_f0_t<function_t<Ret(Args...)> > >
>;
...
DECLARE_FUNCTION_3_ARGS(5, LIFTA2_TYPE(T0, T1, T2, T3, T4), liftA2, function_t<T2(T3, T4, Args...)> const&, T1 const&, T0 const&);
...
using liftA3_type = std::enable_if_t<
    ...
    typeof_t<AZ, remove_f0_t<function_t<Ret(Args...)> > >
>;
...
DECLARE_FUNCTION_4_ARGS(7, LIFTA3_TYPE(T0, T1, T2, T3, T4, T5, T6), liftA3, function_t<T3(T4, T5, T6, Args...)> const&, T2 const&, T1 const&, T0 const&);
