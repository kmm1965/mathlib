...
struct _Monad // Default implementation of some functions
{
    ...
    template<typename A>
    struct mreturn_ {
        constexpr typeof_t<_M, A> operator()(A const& x) const {
            return _Monad<_M>::mreturn(x);
        }
    };
    ...
    template<typename FuncImpl, typename Ret, typename Arg, typename... Args>
    static constexpr auto liftM(function2<Ret(Arg, Args...), FuncImpl> const& f){
    ...
    template<typename FuncImpl, typename Ret, typename Arg1, typename Arg2, typename... Args>
    static constexpr auto liftM2(function2<Ret(Arg1, Arg2, Args...), FuncImpl> const& f){
    ...
    template<typename FuncImpl, typename Ret, typename Arg1, typename Arg2, typename Arg3, typename... Args>
    static constexpr auto liftM3(function2<Ret(Arg1, Arg2, Arg3, Args...), FuncImpl> const& f){
    ...
    template<typename FuncImpl, typename Ret, typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename... Args>
    static constexpr auto liftM4(function2<Ret(Arg1, Arg2, Arg3, Arg4, Args...), FuncImpl> const& f){
        return _([f](typeof_dt<_M, Arg1> const& m1, typeof_dt<_M, Arg2> const& m2,
    ...
    template<typename FuncImpl, typename Ret, typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5, typename... Args>
    static constexpr auto liftM5(function2<Ret(Arg1, Arg2, Arg3, Arg4, Arg5, Args...), FuncImpl> const& f){
        return _([f](typeof_dt<_M, Arg1> const& m1, typeof_dt<_M, Arg2> const& m2,
...
#define DECLARE_MONAD_CLASS(M, _M) \
    ...
    static constexpr remove_f0_t<function2<M<Ret>(Args...)> > \
    mbind(M<fdecay<Arg> > const& m, function2<M<Ret>(Arg0 const&, Args...)> const& f); \
