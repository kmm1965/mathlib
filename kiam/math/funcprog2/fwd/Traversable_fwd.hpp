...
DECLARE_FUNCTION_2(4, TRAVERSE_TYPE(T0, T1, T2), traverse, FUNCTION2(T1(T2), T3) const&, T0 const&);
...
DECLARE_FUNCTION_2(4, MAPM_TYPE(T0, T1, T2), mapM, FUNCTION2(T1(T2), T3) const&, T0 const&);
